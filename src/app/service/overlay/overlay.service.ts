...
export class OverlayService {
  ...
  public createOverlay(): void{
    ...
    const componentPortal: ComponentPortal<OverlayComponent> = new ComponentPortal(OverlayComponent);

    const componentRef: ComponentRef<OverlayComponent> = overlayRef.attach(componentPortal);
  }
